        ...
        <form>
          ...
          <div className="form-row">
            <div className="form-group col-md-12">
              <label>
                Employee Type:{" "}
                <b>{this.state.typeId === 1 ? "Regular" : "Contractual"}</b>
              </label>
            </div>
          </div>
          ...
          {this.state.typeId === 1 ? (
            <div className="form-row">
              <div className="form-group col-md-6">
                <label>Salary: {this.state.monthlySalary} </label>
                <input
                  type="text"
            ...
            <div className="form-row">
              <div className="form-group col-md-6">
                <label>Rate Per Day: {this.state.ratePerDay} </label>
                <input
                  type="text"
                  className="form-control"
                  id="inputWorkDays4"
          ...
          <div className="form-row">
            <div className="form-group col-md-12">
              <label>
                Net Income: <b>{this.state.netIncome?.toFixed("2")}</b>
              </label>
            </div>
          </div>
  ...
  async calculateSalary() {
    ...
    const requestOptions = {
      ...
      body: JSON.stringify({
        ...
        ratePerday:this.state.ratePerDay,
